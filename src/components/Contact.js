  ...
  return (
    <section className='my-28' id='contact'>
      <header className='px-5 text-2xl font-bold pt-10'>
        <h2>Contact Me</h2>
        <p className='text-base font-thin'>If you say your thoughts, I'll be happy!</p>
      </header>
      ...
      <div className='relative md:bottom-56 mr-auto ml-auto md:mr-auto md:ml-0 max-w-xs md:max-w-sm bottom-rocket' onClick={() => window.scroll(0, 0)}>
        <picture>
